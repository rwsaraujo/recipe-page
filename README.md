...
| 🪧 Vitrine Dev |     |
| ------------- | --- |
| ✨ Nome        | **Recipe page** - devChallenges |
| 🏷️ Tecnologias | HTML, Sass, JavaScript, Gulp |
| 🚀 URL Front-end | [**Acesse o site**](https://araujowebdev.github.io/Recipe-Page---devChallenges/) ou veja como rodar localmente no item [**⚙️ Como usar**](#howto) |
| 🔥 Desafio     | [devChallenges - Recipe page](https://devchallenges.io/challenges/OEKdUZ6xs0h99C38XVht) |

![](https://raw.githubusercontent.com/araujowebdev/Recipe-Page---devChallenges/main/dist/assets/imgs/page-view-recipe.jpg))
...
```
git clone https://github.com/araujowebdev/Recipe-Page---devChallenges.git
```
...
```
[00:00:00] Using gulpfile ~/Recipe-Page---devChallenges/gulpfile.js
